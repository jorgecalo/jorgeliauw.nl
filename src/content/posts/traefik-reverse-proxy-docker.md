...
pubDate: "2022-05-09T11:19:40+01:00"
...
<figure class="my-8">
  <img src="/images/traefik-architecture.png" alt="Traefik reverse proxy architecture" class="rounded-xl shadow-lg border border-slate-800 mx-auto max-h-[500px] object-cover" loading="lazy" />
  <figcaption class="text-center text-sm text-slate-400 mt-3">Traefik reverse proxy architecture</figcaption>
</figure>
...
<figure class="my-8">
  <img src="/images/traefik-proxy-docker.png" alt="Traefik reverse proxy interacting with Docker" class="rounded-xl shadow-lg border border-slate-800 mx-auto max-h-[500px] object-cover" loading="lazy" />
  <figcaption class="text-center text-sm text-slate-400 mt-3">Traefik reverse proxy interacting with Docker</figcaption>
</figure>
